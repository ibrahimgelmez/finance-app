...
const loginScreen = () => {
  ...
  return (
    <ImageBackground source={resim} style={{ width: '100%', height: '100%', flex: 1 }}>
      ...
      <View style={{
        ...
        <Text style={{ color: '#ffffff', fontSize: 24, textAlign: 'center', marginBottom: 10 }}>Finance App</Text>
        <Text style={{ color: '#ffffff', fontSize: 16, textAlign: 'center', marginBottom: 20 }}>
          Manage your finances efficiently with our app. Track expenses, set budgets, and more.
        </Text>
